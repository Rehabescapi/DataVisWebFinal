        ...
        function update() {
          g.selectAll("path")
            ...
            .on("click", function (d) {
              ...
              if (d.target.attributes.getNamedItem("TotalPopulation").value > 0) {
                //school ID and year

                newChoropleth.dispatch.call("selected", {}, [
                  d.target.attributes.getNamedItem("sID").value,
                  d.target.attributes.getNamedItem("Year").value,
                ]);
              }
            });
        }
